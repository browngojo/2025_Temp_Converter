...
import conversion_rouding as cr
...
class Converter():
    ...
    def __init__(self):
        ...
        instructions = "Please enter a temperature below and then press one " \
                       "of the buttons to convert it from centigrade to Fahrenheit."
    ...
    def convert(self, min_temp, to_convert):
        ...
        if min_temp == c.ABS_ZERO_CELSIUS:
            ...
            answer_statement = f"Converting {to_convert}°C to {answer}°F"
        else:
            answer = cr.to_celsius(to_convert)
            answer_statement = f"Converting {to_convert}°F to {answer}°C"
